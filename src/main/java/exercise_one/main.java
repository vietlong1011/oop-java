...
import exercise_one.job.ActionPersonnel;
        ...
        while (true) {
            ...
            switch (line) {
                case "1": {
                    ...
                    switch (number) {
                        case 1: {
                            ActionEmployee ae = new ActionEmployee();
                            actionCadres.cadresList.add(ae.addEmployee());
                            break;
                        }
                        case 2: {
                            ActionEngineer aen = new ActionEngineer();
                            actionCadres.cadresList.add(aen.addEngineer());
                            break;
                        }
                        case 3: {
                            ActionPersonnel ap = new ActionPersonnel();
                            actionCadres.cadresList.add(ap.addPersonnel());
                            break;
                        }
                        default:
                ...
                case "3": {
                    // ham CadresList no k nhan du lieu nua
